<x-guest-layout>
    <div class="mb-10 text-center">
        <h1 class="text-3xl font-black uppercase italic tracking-tighter">{{ __('login.Welcome') }}</h1>
        <p class="text-[10px] font-bold text-gray-500 uppercase tracking-widest mt-2">{{ __('login.Init') }}</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div class="space-y-2">
            <label class="text-[9px] font-black uppercase tracking-widest text-brand-indigo ml-2">{{ __('login.Email') }}</label>
        ...
        <div class="space-y-2">
            <label class="text-[9px] font-black uppercase tracking-widest text-brand-indigo ml-2">{{ __('login.Password') }}</label>
        ...
        <div class="flex items-center justify-between px-2">
            <label class="flex items-center gap-3 cursor-pointer group">
                ...
                <span class="text-[10px] font-black uppercase tracking-widest text-gray-500 group-hover:text-gray-300 transition-colors">{{ __('login.Keep_Alive') }}</span>
            </label>
        </div>
