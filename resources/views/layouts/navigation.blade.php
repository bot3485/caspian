        ...
        <div class="flex justify-between h-20">
            <div class="flex items-center gap-8">
                ...
                <a href="{{ route('dashboard') }}" class="group flex items-center gap-3">
                    <div class="w-10 h-10 bg-indigo-600 rounded-xl flex items-center justify-center shadow-[0_0_15px_rgba(79,70,229,0.5)] group-hover:scale-110 transition-transform">
                ...
                <div class="hidden space-x-1 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="px-5 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest !border-none hover:bg-white/5 transition-colors">
                        Hub
                    </x-nav-link>
                    <x-nav-link :href="route('chat')" :active="request()->routeIs('chat')" class="px-5 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest !border-none hover:bg-white/5 transition-colors">
                        Roulette
                    </x-nav-link>
                    <x-nav-link :href="route('rooms.index')" :active="request()->routeIs('rooms.*')" class="px-5 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest !border-none hover:bg-white/5 transition-colors">
                        Spaces
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="64">
                    <x-slot name="trigger">
                        <button class="flex items-center gap-3 p-1.5 pr-4 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 transition-all group">
                            <div class="w-10 h-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center text-sm font-black">
