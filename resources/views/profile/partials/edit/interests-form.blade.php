<section class="space-y-6 mt-12 pt-12 border-t border-white/5">
    <header>
        <h2 class="text-xl font-black tracking-tight text-white uppercase italic">{{ __('settings.Interests_Matrix') }}</h2>
